            ...
            <div className="p-6 sm:p-8 space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                  Track and manage issued checks
                </p>
              </div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-md bg-rose-100 dark:bg-rose-900/30">
                      <CreditCard className="h-5 w-5 text-rose-600 dark:text-rose-400" />
                    </div>
                    <div>
                      <CardTitle>Checks Module</CardTitle>
                ...
                <CardContent>
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-sm">
                      The checks module is currently being developed. 
                      You'll be able to track issued checks here soon.
                    </p>
                  </div>
                </CardContent>
              </Card>
