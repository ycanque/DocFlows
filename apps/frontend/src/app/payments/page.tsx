              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle>Payment Requests Module</CardTitle>
                ...
                <CardContent>
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-sm">
                      The payment requests module is currently being developed. 
                      You'll be able to create and track payment requests here soon.
                    </p>
                  </div>
                </CardContent>
              </Card>
