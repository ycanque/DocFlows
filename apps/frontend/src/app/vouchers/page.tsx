            ...
            <div className="p-6 sm:p-8 space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                  Manage check vouchers and disbursements
                </p>
              </div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-md bg-indigo-100 dark:bg-indigo-900/30">
                      <CheckSquare className="h-5 w-5 text-indigo-600 dark:text-indigo-400" />
                    </div>
                    <div>
                      <CardTitle>Check Vouchers Module</CardTitle>
                ...
                <CardContent>
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-sm">
                      The check vouchers module is currently being developed. 
                      You'll be able to process vouchers here soon.
                    </p>
                  </div>
                </CardContent>
              </Card>
